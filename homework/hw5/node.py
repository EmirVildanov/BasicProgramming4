...
from typing import Tuple, cast, Iterator, TypeVar, Generic, Optional
...
class Node(Generic[K, V]):
    ...
    def insert(self, key: K, priority: V) -> Node[K, V]:
        ...
        # greater_keys = (
        #     bigger_tree_node
        #     if key not in bigger_tree_node
        #     else cast(Node, bigger_tree_node).without_smallest_key()
        # )
        # new_key_node = Node(key, priority, None, None)
        # return smaller_tree_node.merge(new_key_node).merge(greater_keys)
